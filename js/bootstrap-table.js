...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatLoadingMessage: function () {
            return '<img src="image/loading.gif" style="width: 15px; height:15px"/>';
        },
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s Data per Halaman', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Menampilkan %s - %s Dari %s Baris', pageFrom, pageTo, totalRows);
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-default tip" data-toggle="tooltip" type="button" name="refresh" title="%s">',
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn btn-default tip" type="button" name="toggle" title="%s">',
                this.options.formatToggle()),
                '<i class="fa fa-list-alt icon-list-alt"></i>',
                '</button>');
        }
